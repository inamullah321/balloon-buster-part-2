...
for(var i=65; i<390; i=i+65){
red_balloon=createSprite(50,i,1,1);
red_balloon.addImage(red_balloonImage);
red_balloon.scale=0.1;
}
for(var i=85; i<390; i=i+85){
  blue_balloon=createSprite(80,i,1,1);
  blue_balloon.addImage(blue_balloonImage);
  blue_balloon.scale=0.1;

}

for(var i=105; i<390; i=i+105){
  green_balloon=createSprite(110,i,1,1);
  green_balloon.addImage(green_balloonImage);
  green_balloon.scale=0.1;
}


  for(var i=125; i<390; i=i+125){
    pink_balloon=createSprite(140,i,1,1);
